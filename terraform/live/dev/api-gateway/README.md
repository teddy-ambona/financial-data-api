...
| Name | Type |
|------|------|
| [aws_cloudwatch_log_group.debug_apigateway](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/cloudwatch_log_group) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_log_group"></a> [aws\_log\_group](#input\_aws\_log\_group) | Log group for the api-gateway | `string` | n/a | yes |
